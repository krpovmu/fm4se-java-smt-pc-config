...
public class PcConfigGeneratorAndSolver {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] mandatoryComponents = {"CPU","motherboard","RAM","storage"};
		List<String> kindComponentsMandatory = Arrays.asList(mandatoryComponents);
		
//		for (String string : kindComponentsMandatory) {
...
//		}
		...
		// red csv components
//		PcConfigReader components = PcConfigReader.getComponents(null);
